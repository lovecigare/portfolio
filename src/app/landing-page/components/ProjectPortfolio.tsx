...
const ProjectPortfolio = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      technologies: ['Solana', 'solana-web3.js', 'Next.js', 'Express.js', 'MongoDB'],
    ...
    },
    {
      ...
      image: "assets/images/portfolio/hashgreed.png",
    ...
    },
    {
      ...
      image: "assets/images/portfolio/swag.png",
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map((category) =>
            <button
              ...
              disabled={!isHydrated}
              className={`px-6 py-3 rounded-lg font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed ${selectedCategory === category ?
